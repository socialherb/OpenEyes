...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton share_btn = (FloatingActionButton) findViewById(R.id.share_btn);
        ...
        share_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    share_link();
                    Log.i(this.getClass().getSimpleName(), "clicked");
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void share_link() {
        ...
        msg.putExtra(Intent.EXTRA_TEXT, getString(R.string.app_description)+"\n https://play.google.com/store/apps/details?id=com.socialherb.openeyes");
